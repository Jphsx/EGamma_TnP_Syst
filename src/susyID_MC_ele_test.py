...
process.TnP_Electron_ID = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    InputFileNames = cms.vstring(#"root://eoscms//eos/cms/store/cmst3/user/botta/TnPtrees/tnpZ_Data.190456-193557.root",
                                 #"tnpZ_withNVtxWeights.root"
                                 #"file:tnpZ_MC.root"
                                 #"/home/t3-ku/janguian/CMSSW_10_2_5/src/tnpZ_MC.root",
                                 'TnPDYJetsToLL/TnPDYJetsToLL_Pt-100To250_0_1.root',
                                 'TnPDYJetsToLL/TnPDYJetsToLL_Pt-100To250_0_2.root',
                                 'TnPDYJetsToLL/TnPDYJetsToLL_Pt-100To250_0_3.root',
                                 'TnPDYJetsToLL/TnPDYJetsToLL_Pt-100To250_0_4.root',
                                 'TnPDYJetsToLL/TnPDYJetsToLL_Pt-100To250_0_5.root'
                                 #'TnPSingleElectron/KUTnP_DYJets_100To250_6.root',
                                 #'TnPSingleElectron/KUTnP_DYJets_100To250_7.root',
                                 #'TnPSingleElectron/KUTnP_DYJets_100To250_8.root',
                                 #'TnPSingleElectron/KUTnP_DYJets_100To250_9.root'
	...
	#Medium = cms.vstring("Medium Muon", "dummy[pass=1,fail=0]"),	
        passingMVA94XFall17SUSYtight = cms.vstring("MVA SUSY tight wp", "dummy[pass=1,fail=0]"), 
        passingMVA94XFall17SUSYveryLoose = cms.vstring("MVA SUSY very loose wp", "dummy[pass=1,fail=0]"),
        #tag_IsoMu24_eta2p1 = cms.vstring("Medium Muon", "dummy[pass=1,fail=0]"),i
    ),
    Cuts = cms.PSet(
	SIP4 = cms.vstring("SIP4", "el_sip", "2"),

	Mini = cms.vstring("Mini", "el_miniIsoAll_fall17", "5")
    ),
    ...
    Efficiencies = cms.PSet(
        TightSUSY_pt_eta = cms.PSet(
            ...
            #EfficiencyCategoryAndState = cms.vstring("passingMVA94XFall17SUSYtight", "pass", "SIP4", "below", "Mini", "below"),
            EfficiencyCategoryAndState = cms.vstring("passingMVA94XFall17SUSYtight", "pass", "Mini", "below"),
	    BinnedVariables = cms.PSet(
                ## Binning in continuous variables
                el_pt  = cms.vdouble(0, 5, 10, 20, 30, 40, 60, 100 ),
                el_abseta = cms.vdouble(0.0, 0.8, 1.479, 2.5),
                ## flags and conditions required at the denominator, 
                #passingMVA94XFall17SUSYveryLoose = cms.vstring("pass")
                passingMVA94XFall17SUSYtight = cms.vstring("pass")
