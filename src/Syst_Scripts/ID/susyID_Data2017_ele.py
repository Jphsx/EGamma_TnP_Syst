...
process.TnP_Electron_ID = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string(args[0]),
    ...
    Efficiencies = cms.PSet(
        TightSUSY_pt_eta = cms.PSet(
           ...
           # EfficiencyCategoryAndState = cms.vstring("SIP4", "below"),
            ...
            #EfficiencyCategoryAndState = cms.vstring("passingMVA94XFall17SUSYveryLoose", "pass", "passEleVeryLoose", "pass"),
         #   EfficiencyCategoryAndState = cms.vstring("passingMVA94XFall17SUSYtight", "pass"),
	    BinnedVariables = cms.PSet(
                ## Binning in continuous variables
                #pt     = cms.vdouble( 10, 20, 30, 40, 60, 100 ),
                #abseta = cms.vdouble( 0.0, 1.2, 2.4),
                el_pt  = cms.vdouble(0, 20, 100 ),
...
if(args[2] == "s11"):
    shape = "vpvPlusExpo"
    process.TnP_Electron_ID.Variables.mass = cms.vstring("Tag-electron Mass", "79", "120", "GeV/c^{2}")
    nbins = cms.uint32(30)
if(args[2] == "s12"):
    shape = "vpvPlusExpo"
    process.TnP_Electron_ID.Variables.mass = cms.vstring("Tag-electron Mass", "79", "120", "GeV/c^{2}")
...
#evaluate WP arg[2]
if(args[1] == "ID"):
    setattr(process.TnP_Electron_ID.Efficiencies, "TightSUSY_pt_eta", cms.PSet(
	EfficiencyCategoryAndState = cms.vstring("passingMVA94XFall17SUSYtight", "pass"),
	UnbinnedVariables = cms.vstring("mass"),
	BinnedVariables = cms.PSet(
		el_pt  = cms.vdouble(0, 20, 100 ),
    ...
    process.TnP_Electron_ID.binsForFit = nbins
